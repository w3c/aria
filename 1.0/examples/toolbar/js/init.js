/*  init.js
 *  Author: James Craig 2009 while Apple member rep for W3C PFWG
 *  Purpose: WAI-ARIA Test Suite
 *
 *--------------------------------------------------------------------------*/
...
Event.observe(window, 'load', loadWidgets); // may want to use onDOMContentLoaded instead of onLoad
