...
<?php include "_header.phi"; ?>
		...
		<section>
			...
			<p>Employees of Member organizations automatically have the right to participate. To join, ask your <a href="/Member/ACList">W3C Advisory Committee (AC) Representative</a> to <a href="http://www.w3.org/2004/01/pp-impl/83726/join">nominate you to the Working Group</a>. You can also use available <a href="contribute">public contribution channels</a> without joining the group if you or your employer prefer.</p>
		</section>
		<section>
			<h2>Individuals</h2>
			<p>If you do <strong>not</strong> work for a <a href="http://www.w3.org/Consortium/Member/List">W3C Member organization</a>, but you feel you have the expertise and availability to participate, you should first use <a href="contribute">public contribution channels</a> to familiarize yourself with the work and make yourself known to the group. If your contribution suggests a higher level of participation is warranted, you can be invited to join the group as an Invited Expert. Please <a href="mailto:group-aria-chairs@w3.org">contact the WG chairs</a> to discuss this. If you work for an organization whose business is related to that of the W3C, we may instead ask your organization to join and nominate you as a Member representative.</p>
