...
function getDfnTitles(elem) {
  ...
  } else if (elem.childNodes.length === 1 && elem.getElementsByTagName("abbr").length === 1 && child.title) {
...
function linkCrossReferences() {
  ...
  var specBaseURL = respecConfig.ariaSpecURLs ? respecConfig.ariaSpecURLs[respecConfig.specStatus] : null;

  var coreMappingURL = respecConfig.coreMappingURLs ? respecConfig.coreMappingURLs[respecConfig.specStatus] : null;

  var accNameURL = respecConfig.accNameURLs ? respecConfig.accNameURLs[respecConfig.specStatus] : null;

  var htmlMappingURL = respecConfig.htmlMappingURLs ? respecConfig.htmlMappingURLs[respecConfig.specStatus] : null;

  var dpubModURL = respecConfig.dpubModURLs ? respecConfig.dpubModURLs[respecConfig.specStatus] : null;

  var graphicsModURL = respecConfig.graphicsModURLs ? respecConfig.graphicsModURLs[respecConfig.specStatus] : null;
  var graphicsMappingModURL = respecConfig.graphicsMappingModURLs ? respecConfig.graphicsMappingModURLs[respecConfig.specStatus] : null;
  var practicesURL = respecConfig.practicesURLs ? respecConfig.practicesURLs[respecConfig.specStatus] : null;

  function setHrefs(selString, baseUrl) {
    Array.prototype.slice.call(document.querySelectorAll(selString)).forEach(function (el) {
  ...
  Array.prototype.slice.call(document.querySelectorAll(".termref")).forEach(function (item) {
...
function updateReferences(base) {
  ...
  var sectionMap = {};
  Array.prototype.slice.call(base.querySelectorAll("pref, sref, rref")).forEach(function (item) {
    ...
    var theClass = isPreref ? "property-reference" : isSref ? "state-reference" : "role-reference";
...
function restrictReferences(utils, content) {
  ...
  Array.prototype.slice.call(base.querySelectorAll("dfn")).forEach(function (item) {
